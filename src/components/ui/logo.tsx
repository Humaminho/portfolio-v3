...
export function Logo({ className = '', size = 'md' }: LogoProps) {
	...
	return (
		<div
			className={`group hover:rotate-180 duration-300 transition-all ${className}`}
		>
			<svg
				width="45"
				height="45"
				...
				className={`${sizeClasses[size]} text-foreground hover:text-primary transition-colors overflow-visible`}
			>
				<path
